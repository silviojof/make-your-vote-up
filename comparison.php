...
<body>
  ...
  <div class="expanded row collapse" id="parties-topic">
    <div class="small-12 medium-6 large-3 column comp-party" id="comp-conservative">
      <header class="comp-header">
        <h2>conservative<span class="comp-vote">0</span></h2>
      </header>
      <div class="comp-body">
        <div class="comp-text">
          <ul>
            <li>Continues to advocate for new energy   pipelines to bring Alberta crude to global markets.</li>
            <li>The Conservatives pledged to cut Canada’s greenhouse-gas emissions by 30 per cent from 2005 levels before 2030, but with no plan for additional regulations for oil-sands development. </li>
            <li>Invest heavily in green energy and energy-efficient technology</li>
          </ul>
        </div>
    ...
    <div class="small-12 medium-6 large-3 column comp-party" id="comp-green">
      <header class="comp-header">
        <h2>green<span class="comp-vote">0</span></h2>
      </header>
      <div class="comp-body">
        <div class="comp-text">
          <ul>
    ...
    <div class="small-12 medium-6 large-3 column comp-party" id="comp-democratic">
      <header class="comp-header">
        <h2>new democratic<span class="comp-vote">0</span></h2>
      </header>
      <div class="comp-body">
        <div class="comp-text">
          <ul>
    ...
    <div class="small-12 medium-6 large-3 column comp-party" id="comp-liberal">
      <header class="comp-header">
        <h2>liberal<span class="comp-vote">0</span></h2>
      </header>
      <div class="comp-body">
        <div class="comp-text">
          <ul>
