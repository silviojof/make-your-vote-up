<div class="email-modal">
  <div class="email-modal-box">
    <i class="fa fa-times" id="modal-close" aria-hidden="true"></i>
...
<footer class="main-footer">
 <div class="row expanded small-collapse">
   <div class="small-4 columns footer-side footer-social">
   ...
   <div class="small-8 columns footer-side footer-subscribe">
