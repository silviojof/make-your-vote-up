...
<body>
  ...
  <div>
    <div class='party-page small-12 medium-12 large-6 column'>
      <div class='small-12 medium-12 large-12 column representative'>
        <img class='party-logo' src='img/conservative_party.svg'/>
        <h2>REPRESENTATIVE</h2>
      <div class='small-12 medium-6 large-6 column remove-padding'>
          <img class='representative-party' src='img/party-leaders/ronaAmbrose.jpg'/>
      </div>
      <div class='small-12 medium-6 large-6 column remove-padding'>
      ...
      <div class='large-12 column party-info'>
    ...
    <div>
      <div class='medium-12 large-6 column remove-padding'>
        <div class='medium-12 large-12 column remove-padding proposal' id='bg-image'>
          <div class='hide-for-small-only over-lay'></div>

          <div class='expanded row hide-for-large hide-for-medium'>
            <h1>PROPOSALS</h1>
            <div class='small-12 column comp-selectbox'>
              <div class='selectBox'>
            ...
            <div class='small-12 column comp-topic'>
